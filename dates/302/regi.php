...
//包含数据库连接文件
include('conn.php');
$check_query = mysql_query("select * from threetwo where username='$username' limit 1");
...
$sql = "INSERT INTO threetwo(username,regdate,ip)VALUES('$username',$regdate,'$ip')";
ini_set("session.cookie_domain",'wjlnb.com');//注：此句必须放在session_start()之前
session_start();
$_SESSION['username'] = $username;
if(mysql_query($sql,$conn)){
        echo "<script>location.href='https://study.wjlnb.com/dates/302/pyspecial';</script>";
} else {
